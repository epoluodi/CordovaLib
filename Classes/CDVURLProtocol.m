...
+ (BOOL)canInitWithRequest:(NSURLRequest*)theRequest
{
    ...
    } else if ([[theUrl scheme] isEqualToString:@"stereo"])
    {
...
- (void)startLoading
{
    ...
    if ([[url scheme] isEqualToString:@"stereo"])
    {

        NSString *file = [NSString stringWithFormat:@"%@.jpg",[url.absoluteString stringByReplacingOccurrencesOfString:@"stereo://" withString:@""]];
        
//        NSData *data  = UIImageJPEGRepresentation([UIImage imageNamed:@"logo"], 1.0);
        NSData *data = [[NSData alloc] initWithContentsOfFile:[NSString stringWithFormat:@"%@/%@",NSTemporaryDirectory(),file]];
        [self sendResponseWithResponseCode:200 data:data mimeType:@"image/jpg"];
        return;
    }
